...
const zh_CN = {
    ...
    desc: "一门面向大数据和AI的语言",
    ease_of_use: "易于使用",
    ease_of_use_desc: `MLSQL非常易于使用，以SQL为基本语法单元，支持命令行形态，内嵌Python，可以直接分布式操作海量数据源，玩转数据于弹指之间。`,
    data_security: "数据安全",
...
select rf_predict(features) from data as result;`,
    ...
    aliyun_support_desc2: "用户可以轻易的将MLSQL引擎部署于支持K8s部署的各种云以及私有部署上。我们同时也支持Yarn等部署模式。",
